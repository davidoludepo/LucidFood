...
public class LoginActivity extends AppCompatActivity {
    ...
    public void AccessifCorrect(View view) {
        ...
        Parcelable[] parcel = getIntent().getParcelableArrayExtra("selectedItems");
        ...
        if (UsernameField.getText().toString().equals("admin") && PasswordField.getText().toString().equals("1234")) {
            ...
            outTent.putParcelableArrayListExtra("BabaOsheyGanni", StephenCurry);
